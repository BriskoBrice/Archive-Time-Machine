...
- **Voyager en** : ouvre une capsule temporelle entre 1980 et 2005.
- **Pépite de la capsule** : met en avant une découverte atypique issue des résultats réels.
- **Encore plus profond** : relance l’exploration en limitant les répétitions.
- **Filtre français** : privilégie les contenus dont la langue est renseignée comme française dans Internet Archive.
...
Projet indépendant, non affilié à Internet Archive.
